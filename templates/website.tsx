...
export default function WebsiteTemplate (props: websiteProps) {
...
return <div
    style={{
      ...
      backgroundImage:`url("https://www.covalenthq.com/static/images/backgrounds/covalent-backgrounds/${props.bg}.jpg")`,

    }}
  >
    <div style={{display: "flex", position: "absolute", top:"40px", left:"70px"}}>
      <img className="logo" src="https://www.covalenthq.com/static/images/branding/full-horizontal/horizontal-tri-white.png" alt={''}  width={320}/>
    </div>
    <div className="subtitle" style={{display: "flex", position:"absolute", top:"60px", right: "60px", color: "white", fontSize: "30px", letterSpacing: "0.4em", textTransform: "uppercase"}}>
       {props.subtitle}
    </div>
    <label className="header" style={{display: "flex", width: "100%", fontSize: "70px", wordWrap: "break-word", marginBottom: "20px"}}>
     {props.title ? props.title : `One unified API" <br/> <span class="second-br"> One billion possibilities </span>`}
    </label>
    <div className="footer" style={{display: "flex", width:"100%", justifyContent: "space-between", alignItems: "center", height: "100px", borderTop: "solid #FF4C8B 2px"}}>
        <div className="socials"  style={{display: "flex", alignItems: "center", justifyContent: "center", height: "50%", fontSize:"20px", color:"white", fontWeight:"400"}}>
            <svg style={{marginRight:"5px"}} width="40" height="40" viewBox="0 0 32 32" fill="#FF4C8B" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="socials" style={{display: "flex", alignItems: "center", justifyContent: "center", height: "30%", fontSize:"20px", color:"white", fontWeight:"400"}}>
            <svg style={{marginRight:"5px"}} width="40" height="40" viewBox="0 0 28 32" fill="#FF4C8B" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0)">
        ...
        <div className="socials"  style={{display: "flex", alignItems: "center", justifyContent: "center", height: "50%", fontSize:"20px", color:"white", fontWeight:"400"}}>
            <svg style={{marginRight:"5px"}} width="45" height="45" viewBox="0 0 101 101" fill="#FF4C8B" xmlns="http://www.w3.org/2000/svg">
